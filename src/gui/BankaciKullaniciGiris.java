...
public final class BankaciKullaniciGiris extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {

    private KullaniciGiris kullaniciGirisObject = null;
    
    private final String KIMLIK_TEXT_ORIGINAL = "Müşteri No";
    private final String SIFRE_TEXT_ORIGINAL = "**********";

    public BankaciKullaniciGiris() {
        initComponents();
        getEdits();  
    }
    ...
    private void initComponents() {
        ...
        girisEkraniPanel.setBackground(new java.awt.Color(255, 246, 195));
        ...
        girisButton.setBackground(new java.awt.Color(204, 204, 0));
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BankaciKullaniciGiris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BankaciKullaniciGiris().setVisible(true);
            }
        });
    }
